...
pub const struct_IMonikerVtbl = extern struct {
    ...
    @"enum": ?*const fn ([*c]IMoniker, WINBOOL, [*c][*c]I@"enum"Moniker) callconv(.c) HRESULT = @import("std").mem.zeroes(?*const fn ([*c]IMoniker, WINBOOL, [*c][*c]I@"enum"Moniker) callconv(.c) HRESULT),
